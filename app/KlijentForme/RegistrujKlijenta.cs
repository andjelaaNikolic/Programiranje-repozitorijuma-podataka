...
{
    public partial class RegistrujKlijenta : Form
    {
        public RegistrujKlijenta()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bool korisnickoImePostoji = KlijentBroker.Instance.postojiKorisnickoIme(korisnickoIme);
            bool emailPostoji = KlijentBroker.Instance.postojiEmail(email);
            ...
            bool uspesno1 = KlijentBroker.Instance.registrujKlijenta(korisnik);
