...
{
    public partial class PodaciOTreneru : Form
    {
        private Korisnik ulogovani;
        public PodaciOTreneru(Korisnik korisnik)
        {
            InitializeComponent();
            ulogovani = korisnik;
        ...
        private void buttonSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool korisnickoImePostoji = TrenerBroker.Instance.postojiKorisnickoImeID(korisnicko_ime, id);
                bool emailPostoji = TrenerBroker.Instance.postojiEmailID(email, id);
                ...
                bool uspesno = TrenerBroker.Instance.promeniTrenera(ulogovani);
                if (uspesno)
                {
