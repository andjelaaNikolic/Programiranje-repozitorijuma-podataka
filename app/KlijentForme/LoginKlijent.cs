...
{
    public partial class LoginKlijent : Form
    {
        public LoginKlijent()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Korisnik korisnik = KlijentBroker.Instance.login(korisnickoIme1, lozinka1);
            if (korisnik != null)
            {
        ...
        {
            RegistrujKlijenta registracija = new RegistrujKlijenta();
            registracija.Show();
            this.Hide();
        }
    }
